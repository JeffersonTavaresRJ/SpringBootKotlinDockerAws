package br.com.kotlin.erudio.integrations.testcontainers
...
open class AbstractIntegration {
    internal class Initializer: ApplicationContextInitializer<ConfigurableApplicationContext> {
        ...
        companion object{
            ...
            private var mysql: MySQLContainer<*> = MySQLContainer("mysql:8.0.34")
            private fun startContainers() {
               Startables.deepStart(Stream.of(mysql)).join();
            }
            private fun createConnectionConfiguration(): MutableMap<String, Any> {
                return java.util.Map.of("spring.datasource.url", mysql.jdbcUrl,
